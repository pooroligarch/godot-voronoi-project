...
@export_enum("Visible", "Hidden", "Captured, Confined") var mouse_mode = 2
...
@export_node_path var pivot : set = set_pivot
...
func _update_mouselook():
	...
	if pivot:
		...
		var offset = position.distance_to(target)
